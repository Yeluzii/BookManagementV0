            ...
            <tr>
                ...
                <td>
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a class="astyle" href="<%request.getContextPath();%>/book/aReturnBook?bId=${record.book.bookId}">归还</a>
                        </c:otherwise>
                    </c:choose>
                </td>
<%--                <a href="<%request.getContextPath();%>/book/aReturnBook?bId=${record.book.bookId}">归还</a>--%>
            </tr>
        </c:forEach>
        </tbody>
    </table>
